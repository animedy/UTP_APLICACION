                            ...
                            <ul class="sortable-list connectList agile-list" id="todo">
                                ...
                                <div class="panel panel-danger">
                                        ...
                                        <div class="panel-footer">
                                            ...
                                            <i class="fa fa-clock-o"></i> <?php echo date('d.m.Y H:i:s', strtotime($pedidoporhacer->Fecha_y_Hora_Pedido)); ?>Hrs.
                                        </div>
                                </div>
                                <?php
                                        }
                        ...
                        <div class="ibox-content">
                            ...
                            <ul class="sortable-list connectList agile-list" id="completed">
                                ...
                                <div class="panel panel-primary">
                                    ...
                                    <div class="panel-footer">
                                        <i class="fa fa-clock-o"></i> <?php echo date('d.m.Y H:i:s', strtotime($pedidocompletado->Fecha_y_Hora_Pedido)); ?>Hrs.
                                    </div>
                                </div>
                                <?php
                                        }
