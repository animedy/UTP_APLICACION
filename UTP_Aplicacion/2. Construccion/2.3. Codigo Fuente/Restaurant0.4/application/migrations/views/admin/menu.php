            ...
            <div class="sidebar-collapse">
                <ul class="nav metismenu" id="side-menu">
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li><a href="empleados" id="registroempleado">Gestion de Empleado</a></li>
                        </ul>
                    </li>
                    <li>
                        <a href="layouts.html"><i class="fa fa-users"></i> <span class="nav-label">Clientes</span> <span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li><a href="clientes" id="categoriainsumo">Gestión de Clientes</a></li>
                        </ul>
                    </li>
                    <li>
                        <a href="#"><i class="fa fa-taxi"></i> <span class="nav-label">Entregas</span><span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level collapse">
                            <li><a href="motos" id="proveedor">Gestion de Entregas</a></li>
                        </ul>
                    </li>
                    <li>
                        <a href="#"><i class="fa fa-envelope"></i> <span class="nav-label">Pedidos </span><span class="label label-warning pull-right">16/24</span></a>
                        <ul class="nav nav-second-level collapse">
                            <li><a href="pedidos">Gestion de Pedidos</a></li>
                            <li><a href="catalogos">Catalogo de Productos</a></li>
                        </ul>
                    </li>
                    <li>
                        <a href="#"><i class="fa fa-bar-chart-o"></i> <span class="nav-label">Reportes</span><span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level collapse">
                            <li><a href="pedidosatendidos" id="">Pedidos Atendidos</a></li>
                            <li><a href="pedidosdevueltos" id="">Pedidos Devueltos</a></li>
                            <li><a href="platosmasvendidos" id="">Platos más Pedidos</a></li>
                            <li><a href="ventasdelmes" id="">Ventas del Mes</a></li>
                            <li><a href="filtropedidos" id="">Filtro de Pedidos</a></li>
                        </ul>
                    </li>
                </ul>
