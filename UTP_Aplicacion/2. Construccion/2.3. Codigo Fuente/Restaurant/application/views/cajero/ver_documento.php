            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                ...
                <div class="col-lg-4">
                    <div class="title-action">
                        ...
                        <a href="<?php echo base_url('Documento');?>"target="_blank" class="btn btn-primary"><i class="fa fa-print"></i> Imprimir </a>
                    </div>
                </div>
            </div>
                    ...
                    <div class="ibox-content p-xl">
                            <div class="row">
                                ...
                                <div class="col-sm-6 text-right">
                                    <h4>Invoice No.</h4>
                                    <h4 class="text-navy"><?php echo $key->idPedidos; ?> INV-000567F7-00</h4>
                                    <span>To:</span>
                                    <address>
